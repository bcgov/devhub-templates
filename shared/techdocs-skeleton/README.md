...
The homepage of your documentation is in the [${{ values.docs_path }}/index.md](${{ values.docs_path }}/index.md) file. Edit it to suit your usage. Warning: do not delete this file. 

Add documentation pages by  adding more markdown (.md) files to the [docs](${{ values.docs_path }}) folder.
